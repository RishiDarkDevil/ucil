...
- **P1-W2-F02, P1-W2-F03, P1-W2-F04, P1-W2-F06** — symbol extraction,
  ...
  listed in WO-0005 `scope_out`; scheduled for subsequent work-orders.
...
incomplete because work is in progress" from "gate incomplete because
something is broken".
...
2. **Planner**: emit the next work-order (WO-0006 — symbol extraction /
   AST-aware chunking or two-tier storage layout) so the remaining Phase-1
   Week-2 features get implemented.
...
and `20260415-1900-WO-0004-gate-expected-incomplete.md`, both of which were
auto-resolved when the verifier ran.
